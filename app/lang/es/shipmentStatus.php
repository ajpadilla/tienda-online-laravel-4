	...
	return array(
		"routes" => array(
			...
			"api" => array(
				...
				"list"=>'estatus-de-envio/api/lista-estatus-de-envio',
				"saveLang" => "estatus-de-envio/api/actualizar-idioma",
				"update" => "estatus-de-envio/api/actualizar",
				"delete" => "estatus-de-envio/api/eliminar"
			),
		),
