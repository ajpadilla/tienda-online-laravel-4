...
{{ trans('classifiedTypes.edit_view.title') }}
@stop
	...
	<div class="col-lg-12">
		<div class="ibox float-e-margins">
			<div class="ibox-title">
				<h5>{{ trans('classifiedTypes.edit_view.subtitle') }}</h5>
			</div>
			<div class="ibox-content">
				<div class="row">
					...
					<div class="col-sm-6 b-r">
						...
						<div class="form-group">
						{{ Form::text('classified_types_id',$classified_type->id, ['class' => 'form-control','id'=>'classified_types_id','style'=>'display: none;']) }}
						</div>
					</div>
					<div class="col-sm-6">
						<div class="form-group">
		...
		$('#formEditClassifiedTypes').validate({
			rules:{
				name:{
					...
					remote:
						{
							url:'{{ URL::to('/checkNameClassifiedTypesEdit/') }}',
							type: 'POST',
							data: {
								name: function() {
									return $('#name').val();
								...
								classified_types_id: function(){
									return $('#classified_types_id').val();
								}
							},
