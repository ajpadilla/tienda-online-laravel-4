<div class="col-lg-7">
	...
	<div class="form-group" style="display: none">
		...
		<div class="col-sm-10">
			{{ Form::text('classified_type_id', null, ['class' => 'form-control', 'placeholder' =>'','id'=> 'classified_type_id_lang']) }}
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			{{ Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Name', 'id' => 'name_classified_type_language']) }}
		</div>
	</div>
