<div class="row">
	<div class="product-page-cart tooltip-pop">
		...
		<div class="col-sm-2">
			<button href="{{ route('cart.create', $product->id) }}" class="btn btn-success btn-outline dim" style="margin-left: 20px" type="button" data-toggle="tooltip" data-placement="top" title="Agregar al carro de compras" data-original-title="Agregar al carro de compras"><i class="fa fa-shopping-cart fa-2x"></i></button>
		</div>
		<div class="col-sm-2">
