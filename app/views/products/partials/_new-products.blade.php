<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
    <div class="product-item">
        ...
        <a href="#" class="btn btn-default add2cart"><i class="fa fa-shopping-cart fa-2x"></i></a>
        <a href="#" class="btn btn-default add2cart"><i class="fa fa-check-square-o fa-2x"></i></a>
