<div class="classified-item">
  <div class="pi-img-wrapper">
    ...
    @else
      <img class="img-responsive" src="{{ asset('/uploads/classifieds/images/model1.jpg') }}" alt="not-path"/>
      <div>
      <a href="{{ asset('/uploads/classifieds/images/model1.jpg') }}" class="btn btn-default fancybox-button" alt="not-path">
        <i class="fa fa-search-plus fa-3x"></i>
      </a>
    @endif
      <a href="#classified-pop-up-{{ $classified->id }}" class="btn btn-default fancybox-fast-view"><i class="fa fa-eye fa-3x"></i></a>
    </div>
    </div>
    <h3>
