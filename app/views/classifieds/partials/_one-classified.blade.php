<div class="product-item">
  <div class="pi-img-wrapper">
    ...
    <img class="img-responsive" src="{{ asset($classified->getFirstPhoto()->complete_path) }}" alt="{{ $classified->getFirstPhoto()->filename }}"/>
    <div>
      <a href="{{ asset($classified->getFirstPhoto()->complete_path) }}" class="btn btn-default fancybox-button" alt=" {{ $classified->getFirstPhoto()->filename }}"><i class="fa fa-search-plus fa-3x"></i>
      </a>
      @else
    ...
    <h3>
    <a href="{{ route('classifieds.show', $classified->id) }}">{{ $classified->getInCurrentLangAttribute()->name }}</a>
    </h3>
