				...
				<div class="row">
					...
					<div class="col-sm-6 b-r">
						<div class="form-group">
							...
							<div class="col-sm-6">
								{{ Form::select('language_id',$languages,$classified_language->id,array('class' => 'form-control','id'=>'language_id')) }}
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								{{ Form::text('name',$classified_language->pivot->name, ['class' => 'form-control']) }}
							</div>
						</div>
						<div class="form-group">
					...
					<div class="col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6">
								{{ Form::text('price',$classified->price, ['class' => 'form-control']) }}
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								{{ Form::select('classified_type_id',$classified_types,$classified->classifiedType->id,array('class' => 'form-control')) }}
							</div>
						</div>
						<div class="form-group">
							{{ Form::label('classified_condition_id', trans('classifieds.labels.classified_condition'),['class'=>'col-sm-2 control-label']) }}
							<div class="col-sm-6">
								{{ Form::select('classified_condition_id',$classified_conditions,$classified->classifiedCondition->id,array('class' => 'form-control')) }}
							</div>
						</div>
						<div class="form-group">
...
<script>
	$(document).ready(function () 
	{
		...
		var options = { 
				...
				url:  '{{URL::route('classifieds.update', $classified->id)}}',
        		type:'POST'
			};
